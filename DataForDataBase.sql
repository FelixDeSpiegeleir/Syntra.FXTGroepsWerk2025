...
-- ✅ Insert 20 Books (met GoodReadsId)
INSERT INTO WatchListItems (WatchListId, Title, ItemType, PagesOrDuration, AuthorId, Genre, Year, GoodReadsId, IsCompleted)
SELECT @BookWatchListId, Title, 'Book', Pages, Id, Genre, Year, GoodReadsId, 0
FROM (VALUES
    ('Harry Potter and the Philosopher''s Stone', 320, 1, 3, 1997, '3'),
    ('A Game of Thrones', 694, 2, 3, 1996, '13496'),
    ('The Hobbit', 310, 3, 3, 1937, '5907'),
    ('Murder on the Orient Express', 256, 4, 5, 1934, '16304'),
    ('The Shining', 447, 5, 4, 1977, '11588'),
    ('Foundation', 255, 6, 7, 1951, '29579'),
    ('2001: A Space Odyssey', 297, 7, 7, 1968, '70535'),
    ('The Call of Cthulhu', 110, 8, 4, 1928, '15730101'),
    ('Frankenstein', 280, 9, 14, 1818, '18490'),
    ('Do Androids Dream of Electric Sheep?', 210, 10, 7, 1968, '36402034'),
    ('Fahrenheit 451', 249, 11, 13, 1953, '17470674'),
    ('The Old Man and the Sea', 127, 12, 14, 1952, '2165'),
    ('Pride and Prejudice', 432, 13, 6, 1813, '1885'),
    ('The Adventures of Tom Sawyer', 274, 14, 14, 1876, '24583'),
    ('War and Peace', 1225, 15, 10, 1869, '656'),
    ('Crime and Punishment', 671, 16, 11, 1866, '7144'),
    ('The Iliad', 704, 17, 12, -800, '1371'),
    ('A Tale of Two Cities', 544, 18, 10, 1859, '1953'),
    ('Hamlet', 500, 19, 2, 1603, '1420'),
    ('Les Misérables', 1463, 20, 10, 1862, '24280')
) AS BookData (Title, Pages, Id, Genre, Year, GoodReadsId);
